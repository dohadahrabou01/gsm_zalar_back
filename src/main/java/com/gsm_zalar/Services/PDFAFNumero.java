...
public class PDFAFNumero {
    ...
    public ByteArrayInputStream generatePdf(int id) {
        ...
        afNumero.setImprim(true);
        afNumeroRepository.save(afNumero);

        String beneficiareName = afNumeroDTO.getBeneficiareDTO().getNom() + "_" + afNumeroDTO.getBeneficiareDTO().getPrenom();
        String dateAffectation = afNumeroDTO.getDate_affectation().replaceAll("[^a-zA-Z0-9]", "_");
        String fileName = beneficiareName + "_" + dateAffectation + ".pdf";
        ...
        try {
            ...
            Paragraph title = new Paragraph("FICHE D'AFFECTATION DU NUMERO")
            ...
            referenceTable.addCell(new Cell().add(new Paragraph(afNumeroDTO.getBeneficiareDTO().getFillialeLibelle())).setFontSize(cellFontSize).setBorder(new SolidBorder(0.5f)));

            referenceTable.addCell(new Cell().add(new Paragraph("Num")).setFontSize(cellFontSize).setBorder(new SolidBorder(0.5f)));
            referenceTable.addCell(new Cell().add(new Paragraph(afNumeroDTO.getNumeroDTO().getNumero())).setFontSize(cellFontSize).setBorder(new SolidBorder(0.5f)));

            referenceTable.addCell(new Cell().add(new Paragraph("Forfait")).setFontSize(cellFontSize).setBorder(new SolidBorder(0.5f)));
            referenceTable.addCell(new Cell().add(new Paragraph(afNumeroDTO.getNumeroDTO().getForfait())).setFontSize(cellFontSize).setBorder(new SolidBorder(0.5f)));

            referenceTable.addCell(new Cell().add(new Paragraph("ICCID")).setFontSize(cellFontSize).setBorder(new SolidBorder(0.5f)));
            referenceTable.addCell(new Cell().add(new Paragraph(afNumeroDTO.getNumeroDTO().getSerie())).setFontSize(cellFontSize).setBorder(new SolidBorder(0.5f)));
            ...
            referenceTable.addCell(new Cell().add(new Paragraph(afNumeroDTO.getDate_affectation())).setFontSize(cellFontSize).setBorder(new SolidBorder(0.5f)));
            ...
            referenceTable1.addCell(new Cell().add(new Paragraph(afNumeroDTO.getBeneficiareDTO().getNom()+" "+afNumeroDTO.getBeneficiareDTO().getPrenom())).setFontSize(cellFontSize).setBorder(new SolidBorder(0.5f)));
            ...
            referenceTable1.addCell(new Cell().add(new Paragraph(afNumeroDTO.getBeneficiareDTO().getFillialeLibelle())).setFontSize(cellFontSize).setBorder(new SolidBorder(0.5f)));
            ...
            referenceTable1.addCell(new Cell().add(new Paragraph(afNumeroDTO.getDate_affectation())).setFontSize(cellFontSize).setFontSize(cellFontSize).setBorder(new SolidBorder(0.5f)));
            ...
            table1.addCell(new Cell().add(new Paragraph(afNumeroDTO.getDate_affectation())).setBorder(new SolidBorder(0.5f)).setFontSize(cellFontSize).setTextAlignment(TextAlignment.CENTER));
